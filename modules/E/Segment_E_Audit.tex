% SSC 2026 Workshop - Segment E: Auditing AI Output
...
\subtitle{Segment E \textbullet\ Modern Analysis of Real-World Data}
...
\begin{frame}{Step 2: Audit}
  \small
  \begin{itemize}
    \item \textcolor{good}{Both time-invariant and baseline covariates measured \emph{before} time zero
      are legitimate confounders}: \vaccept.
...
\begin{frame}{When the Mediator Is the Question}
  ...
  \begin{block}{Controlling for mediators}
    ...
    runs \emph{through} HbA1c or eGFR,that is \textbf{mediation analysis}. With
...
\begin{frame}[standout]
  A confident answer is not a correct one.\\[0.8em]
  Audit each claim \textbf{against its evidence}.
\end{frame}
